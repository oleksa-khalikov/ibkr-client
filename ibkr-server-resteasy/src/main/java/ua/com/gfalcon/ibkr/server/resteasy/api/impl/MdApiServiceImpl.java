...
import ua.com.gfalcon.ibkr.server.resteasy.api.MdApiService;
 ...
 */
@RequestScoped
public class MdApiServiceImpl implements MdApiService {

    /**
     * MD snapshot.
     */
    public Response mdSnapshotGet(String conids, String fields, SecurityContext securityContext)
