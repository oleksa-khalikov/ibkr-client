 ...
 * PnL Api.
 */
public class ProfitAndLossApi {

    private ApiClient apiClient;

    public ProfitAndLossApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ProfitAndLossApi(ApiClient apiClient) {
     ...
     */
    public com.squareup.okhttp.Call iserverAccountPnlPartitionedGetAsync(final ApiCallback<Object> callback)
            throws ApiException {
